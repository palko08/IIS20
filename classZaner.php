...
class Zaner{
    ...
    function checkInterpret($pdo, $interpret_ID){
        ...
        $select->execute(array($this->zanerID, $interpret_ID));
        if($select->rowCount() == 0){
            return 1;
        }else{
            return 0;
    ...
    function checkFestival($pdo, $festival_ID){
        ...
        $select->execute(array($this->zanerID, $festival_ID));
        if($select->rowCount() == 0){
            return 1;
        }else{
            return 0;
    ...
    function setZaner_nazov($pdo, $data){
    	try{
    		...
    		$select->execute(array($data, $this->zanerID));
    		return 0;
    ...
    function addInterpret($pdo, $interpret_ID){
        ...
        $insert->execute(array($interpret_ID, $this->zanerID));
        return 0;
    }
    ...
    function addFestival($pdo, $festival_ID){
        ...
        $insert->execute(array($festival_ID, $this->zanerID));
        return 0;
    }
    ...
    function deleteInterpret($pdo, $interpret_ID){
        ...
        $delete->execute(array($this->zanerID, $interpret_ID));
    ...
    function deleteFestival($pdo, $festival_ID){
        ...
        $delete->execute(array($this->zanerID, $festival_ID));
